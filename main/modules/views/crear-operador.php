...
<?php require('../heads/head-crear-operador.php') ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="crear_operador_validate.php" method="POST" class="form-material m-t-40" id="formularioOperator">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group" id="grupo__email">
                                                ...
                                                <input type="text" class="form-control form-control-line" name="email" id="email" placeholder="ejemplo@email.com" required data-validation-required-message="This field is required">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group" id="grupo__phone" style="overflow: visible !important;">
                                                ...
                                                <input type="text" class="form-control form-control-line" name="phone" id="phone" placeholder="000 000 000" required data-validation-required-message="This field is required">
