...
if(isset($_POST['example-email']) && isset($_POST['localizador']) && isset($_POST['nombre']) && isset($_POST['operador']) && isset($_POST['entrada']) && isset($_POST['salida']) && isset($_POST['movilOperador']) && isset($_POST['pinEntrada']) && isset($_POST['ubiLocker'])) {
  ...
  $txt_accion = '';
  $txt_msg = "Sehr geehrter Herr/Frau ".$nombre.",<br>
  Wir senden Ihnen eine Wegbeschreibung zur Schlüsselübergabe für die reservierte Unterkunft bei <strong>".$operador."</strong>.<br>
  Gehen Sie zum SMART KEY STATION-Punkt, der sich unter dieser <a href='".$ubicacion."'>ADRESSE</a> befindet. Folgen Sie den Anweisungen über den Monitor.";
  $txt_sub = '';
...
$mensaje =
                ...
                <table width="70%" border="0" align="center" style="margin-left: auto; margin-right: auto; background-color: #FFFFFF; color: #000000; font-size: .9em; text-align: left;">
                  <tbody>
                    ...
                    <tr>
                      <td colspan="2" style="text-align:left; padding-left:15px; font-size:1.17em;"><p>'.$txt_msg.'</p><p>Angaben zu Ihrer Reservierung:</p>
                    </tr>
                    <tr>
                      <td width="16%">&nbsp;</td>
                      <td width="84%"></td>
                    ...
                    <tr>
                        <td colspan="2" align="left" style="padding:0px; font-size:1.17em;">
                            <ul>
                                <li><strong>Reservierungsnummer: </strong>'.$idReserva.'</li>
                                <li><strong>Vor- und Nachname: </strong>'.$nombre.'</li>
                                <li><strong>Locator: </strong>'.$localizador.'</li>
                                <li><strong>Ankunft: </strong>'.$entradaFormatada.'</li>
                                <li><strong>Abfahrt: </strong>'.$salidaFormatada.'</li>
                                <li><strong>PIN: </strong>'.$pin.'</li>
                                <li><strong>Kontakt: </strong>'.$movilOperador.'</li>
                            </ul>        
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2" style="text-align:left; padding-left:15px; font-size:1.17em;">
                        <p style="margin-top:30px">Glücklicher Aufenthalt!</p>
                      </td>
                    </tr>
                    <tr>
                ...
                $mail->Subject = 'Ihre Schlüssel an der SMART KEY STATION';
                $mail->Body    = $mensaje;
                $mail->send();
}
?>