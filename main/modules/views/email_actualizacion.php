...
$txt_accion = '';
$txt_msg = "Se ha actualizado la reserva de <strong>".$operador."</strong>";;
$txt_sub = '';
...
<table width="70%" border="0" align="center" style="margin-left: auto; margin-right: auto; background-color: #FFFFFF; color: #000000; font-size: .9em; text-align: left;">
  <tbody>
    ...
    <tr>
      <td colspan="2" style="text-align:left; padding-left:15px; font-size:1.17em;"><p>'.$txt_msg.', insertada en su programa con el PMS de <strong>KEYPOINT SOLUTIONS</strong>.</p><p>A continuación le detallamos los detalles de la misma:</p>
    </tr>
    <tr>
      <td width="16%">&nbsp;</td>
      <td width="84%"></td>
    ...
    <tr>
      <td colspan="2" align="left" style="padding-left:15px; font-size:.85em;"><br /><hr /><br />
        <div>
        '.$objeto_dameOperador->Nombre.'<br />
        '.$objeto_dameOperador->Direccion.'<br />
        '.$objeto_dameOperador->Poblacion.'<br />
        '.$objeto_dameOperador->Telefono.'<br />
        '.$objeto_dameOperador->Email.'<br /></div><br /></td>
    </tr>
    <tr>
