...
<body class="skin-default-dark fixed-layout">
    ...
    <!-- ============================================================== -->
    <?php require('../ws/ws_reservas/ws_reserva_nombre.php') ?>   
    <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Por nombre</h6>
                                <form action="" method="$_POST">
                                    <div class="row">
                                        <div class="col-2">
                                            <label for="numReserva">Introduce el Nombre</label>
                                            <input type="text" class="form-control form-control-line" id="nombreReserva">
    ...
    <script src="../js/mostrarNombrePorReserva.js"></script>
