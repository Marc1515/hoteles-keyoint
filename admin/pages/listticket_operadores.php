...
<table width="100%" cellpadding="5" style="border: 2px solid #000000;">
  <thead>
    <tr class="tabla">
      ...
      <th style="border-bottom-color: #000000; border-bottom-style:solid; border-bottom-width:2px; border-top-color: #000000; border-top-style:solid; border-top-width:2px; border-right-color: #000000; border-right-style:solid; border-right-width:2px; background-color: #2b2f3a; color: #ffffff">Nº Puertas</th>
    </tr>
  </thead>
  <tbody>';
  ...
  if (!is_array($objeto_dameOperadores) && !is_null($objeto_dameOperadores)) {
    ...
    if ($objeto_dameOperadores->IdOperador !== 0 && $objeto_dameOperadores->IdOperador !== 111) {
      ...
      $tbl .= '
      <tr>
        <td style="border-bottom-color: #B8B8B8; border-bottom-style:solid; border-bottom-width:1px; border-top-color: #B8B8B8; border-top-style:solid; border-top-width:1px;">'.$objeto_dameOperadores->IdOperador.'</td>
        <td style="border-bottom-color: #B8B8B8; border-bottom-style:solid; border-bottom-width:1px; border-top-color: #B8B8B8; border-top-style:solid; border-top-width:1px;">'.$objeto_dameOperadores->Nombre.'</td>
        <td style="border-bottom-color: #B8B8B8; border-bottom-style:solid; border-bottom-width:1px; border-top-color: #B8B8B8; border-top-style:solid; border-top-width:1px;">'.$objeto_dameOperadores->Email.'</td>
        <td style="border-bottom-color: #B8B8B8; border-bottom-style:solid; border-bottom-width:1px; border-top-color: #B8B8B8; border-top-style:solid; border-top-width:1px;">'.$objeto_dameOperadores->Movil.'</td>
      </tr>';
  ...
  $tbl .= '
    ...
    for ($step=0; $step<count($objeto_dameOperadores); $step++) {
      ...
      if ($objeto_dameOperadores[$step]->IdOperador !== 0 && $objeto_dameOperadores[$step]->IdOperador !== 111) {
        ...
        $tbl .= '
        <tr>
          <td style="border-bottom-color: #B8B8B8; border-bottom-style:solid; border-bottom-width:1px; border-top-color: #B8B8B8; border-top-style:solid; border-top-width:1px;">'.$objeto_dameOperadores[$step]->IdOperador.'</td>
          <td style="border-bottom-color: #B8B8B8; border-bottom-style:solid; border-bottom-width:1px; border-top-color: #B8B8B8; border-top-style:solid; border-top-width:1px;">'.$objeto_dameOperadores[$step]->Nombre.'</td>
          <td style="border-bottom-color: #B8B8B8; border-bottom-style:solid; border-bottom-width:1px; border-top-color: #B8B8B8; border-top-style:solid; border-top-width:1px;">'.$objeto_dameOperadores[$step]->Email.'</td>
          <td style="border-bottom-color: #B8B8B8; border-bottom-style:solid; border-bottom-width:1px; border-top-color: #B8B8B8; border-top-style:solid; border-top-width:1px;">'.$objeto_dameOperadores[$step]->Movil.'</td>
        </tr>';
...
/*     $desde_get = new DateTime($_GET['fecha_desde']);
    ...
    $this->SetY(10);
    $this->Cell(0, 0, 'Todos los Operadores', 0, 2, 'C', 0, '', 0, false, 'C', 'M');
